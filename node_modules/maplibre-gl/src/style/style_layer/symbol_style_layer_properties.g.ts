...
const getLayout = (): Properties<SymbolLayoutProps> => layout = layout || new Properties({
    ...
    "icon-rotation-alignment": new DataDrivenProperty(styleSpec["layout_symbol"]["icon-rotation-alignment"] as any as StylePropertySpecification, "icon-rotation-alignment"),
