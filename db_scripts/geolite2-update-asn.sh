...
DB_FILENAME="GeoLite2-ASN.mmdb" # Final db name.
DOWNLOAD_URL="https://github.com/GitSquared/node-geolite2-redist/raw/refs/heads/master/redist/GeoLite2-ASN.tar.gz"
LOG_FILE="${SCRIPT_DIR}/geolite2-asn-update.log" # Log file path (ensure writable by runner) or leave default and change below
LOG_MAX_LINES="500"
...
if [ "$UPDATE_NEEDED" = true ]; then
    ...
    send_success_notification "The GeoLite2-ASN.mmdb database was successfully updated."
